...
export function ChatBotWidget() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-50 w-[90vw] md:w-96 max-h-[80vh] bg-card border border-border rounded-lg shadow-2xl overflow-hidden flex flex-col">
          ...
          <form onSubmit={handleSend} className="p-4 border-t border-border flex-shrink-0">
            <div className="flex gap-2">
              <input
                ...
                placeholder={isLoggedIn ? "Ask about seed cycling, your orders..." : "Ask about seed cycling, laddus..."}
